			...
			if (step.Name.Equals("Click Arrow Forward to End of Carousel")) {
				...
				switch(step.Data) {
					case "NFL":
						...
						string[] nfl_players = {"CAM NEWTON", "PATRICK MAHOMES II", "TOM BRADY", "TUA TAGOVAILOA", "DAK PRESCOTT", "ALEX SMITH", "GEORGE KITTLE", "TEDDY BRIDGEWATER", "JOE BURROW", "BAKER MAYFIELD"};
					...
					case "NBA":
						...
						string[] nba_players = {"LEBRON JAMES"};
